...
<html>
  ...
  <li><a href="../view/addstaff.php">Add Staff</a></li>
...
<br>
  ...
  <br>
  <form method="post" action="../view/liststaff.php">
     Filter results by Last Name:
     <input name="uSearch"/>
    <input type="submit" value="Search"/>
    <form action="../view/liststaff.php">
    ...
    <table>
      ...
      <?php foreach($userResults as $user): ?>
        <tr>
          ...
          <td><a href="../view/viewuser.php?USER_ID=<?=$user->USER_ID?>"</a><b>View<b></td>  
        </tr>
        <?php endforeach ?>
      </tbody>
  </body>
