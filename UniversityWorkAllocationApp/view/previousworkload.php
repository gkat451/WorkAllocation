...
<html>
  ...
  <li><a href="../view/manworksummary.php">2020</a></li>
  <li><a href="../view/previousworkload2018.php">2018</a></li>
</ul>
<br>
  <form method="post" action="../view/previousworkload.php">
     2019 Filter results by Last Name:
     <input name="uSearch"/>
    <input type="submit" value="Search"/>
    <form action="../view/previousworkload.php">
