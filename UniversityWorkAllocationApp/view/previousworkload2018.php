...
<html>
  ...
  <li><a href="../view/workloadsummary.php">2020</a></li>
  <li><a href="../view/previousworkload.php">2019</a></li>
</ul>
<br>
  <form method="post" action="../view/previousworkload2018.php">
     Filter results by Last Name:
     <input name="uSearch"/>
    <input type="submit" value="Search"/>
    <form action="../view/previousworkload2018.php">
